  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-12">
      ...
      <p className="mt-2 max-w-2xl text-muted-foreground">
        ...
        Suspending a product here is independent of billing — it&rsquo;s a second gate ahead of
        plan limits, for when access needs to stop regardless of what the customer is paying for.
      </p>
